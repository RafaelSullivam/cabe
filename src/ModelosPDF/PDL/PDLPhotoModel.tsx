...
import { PDLPhotoData } from '../../types/pdlPhotoTypes';
import './PDLPhotoStyles.css';

interface PDLPhotoModelProps {
  data: PDLPhotoData;
}

const PDLPhotoModel: React.FC<PDLPhotoModelProps> = ({ data }) => {
  ...
  return (
    <div className="pdl-photo-container">
      {/* Header */}
      <header className="pdl-photo-header">
      ...
      <main style={{ marginTop: '45px' }}>
            ...
            <tr>
              <td className="tg-0pky" colSpan={15} style={{ borderLeft: 'none', borderRight: 'none', borderTopColor: '#fff', paddingLeft: '0px', paddingRight: '0px', height: '10px' }}>
                <div style={{ border: '1px solid #000', margin: '30px 0px 0px 0px', padding: '5px 5px 0px 5px' }}>
                  <div style={{ width: '50%', marginLeft: '40%', fontFamily: 'Arial, sans-serif', position: 'absolute', zIndex: 1, top: '335px', height: '30px', fontSize: '15px', backgroundColor: '#fff' }}>
                    REGISTRO FOTOGRÁFICO
                  </div>
                  <img 
                    src={`data:image/jpeg;base64,${data.photoImage}`} 
                    alt="Foto" 
                    width="500px" 
                    height="240px" 
        ...
        <table style={{ marginTop: '0px' }}>
          <tbody>
            <tr>
              <td className="tg-0pky" colSpan={15} style={{ borderLeft: 'none', borderRight: 'none', borderTopColor: '#fff', paddingLeft: '0px', paddingRight: '0px', height: '10px' }}>
                <div style={{ border: '1px solid #000', margin: '30px 0px 0px 0px', padding: '5px 5px 0px 5px' }}>
                  <div style={{ width: '50%', marginLeft: '40%', fontFamily: 'Arial, sans-serif', position: 'absolute', zIndex: 1, top: '617px', height: '30px', fontSize: '15px', backgroundColor: '#fff' }}>
                    GEOLOCALIZAÇÃO
                  </div>
                  <img 
                    src={`data:image/jpeg;base64,${data.mapImage}`} 
                    alt="Mapa" 
                    width="500px" 
                    height="240px" 
                    style={{ visibility: 'hidden' }} 
                  ...
                  <img 
                    ...
                    width="475px" 
                    height="200px" 
                    style={{ marginTop: '300px', marginLeft: '10%' }} 
                    id="imagem-sobrepostaComp" 
                  />
                </div>
              </td>
        ...
        {/* Footer */}
        <footer style={{ bottom: 0, marginTop: '50px', width: '100%', fontFamily: 'Arial, sans-serif', fontSize: '10px' }}>
