...
class CaliforniaSupportIndexGraph2
{
        ...
        <style type="text/css">
            ...
            .tg-g2 .tg-g2-0pky {
                ...
                vertical-align: middle;
                 ...
                 #imagem-sobrepostaCBR2 {
                    position: absolute;
                    top: 250; /* Ajuste a posição vertical conforme necessário */
                    left: 45; /* Ajuste a posição horizontal conforme necessário */
    ...
    <header>
        ...
        <table class="tg-cabecalho" style="width: 100%;margin-bottom: 13px">
            ...
            <table class="tg">
                    <tr>
    <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 675px;">                            <div style="border: 1px solid #000; margin: 15px 0px 10px 0px; padding: 5px;">
                             <img src="data:image/jpeg;base64,' . base64_encode($graph) . '" alt="Imagem" width="700px" height="490px" style="visibility: hidden;">
                       <img src="data:image/jpeg;base64,' . base64_encode($graph) . '" alt="Imagem" width="625px" height="400px" id="imagem-sobrepostaCBR2">
                            </div>
                            <table class="tg-g2" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tg-g2-c3ow" colspan="1">Pressão calculada MPa</td>
                                        <td class="tg-g2-c3ow" colspan="1">Pressão corrigida MPa</td>
                                        <td class="tg-g2-c3ow" colspan="1">Pressão calculada MPa</td>
                                        <td class="tg-g2-c3ow" colspan="1">Pressão corrigida MPa</td>
                                        <td class="tg-g2-c3ow" colspan="1">Pressão calculada MPa</td>
                                        <td class="tg-g2-c3ow" colspan="1">Pressão corrigida MPa</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P11']) . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P21']) . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P31'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P41'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P51'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold"></td>
                                    </tr>
                                    <tr>
                                        <td class="tg-g2-0pky" style="text-align: center">5,08 mm</td>
                                        <td class="tg-g2-c3ow" style="text-align: center">%</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P12'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P22'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P32'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P42'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['ISC_P52'])  . '</td>
                                        <td class="tg-g2-c3ow" colspan="2" style="background-color:silver; font-weight:bold"></td>
                                    </tr>
                                </tbody>
                            </table>
