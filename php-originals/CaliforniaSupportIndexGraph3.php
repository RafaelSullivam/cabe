           ...
           <table class="tg">
                <tr>
                    <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 675px;">
                        <div style="border: 1px solid #000; margin: 25px 0px 10px 0px; padding: 5px;">
                            <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                                <img src="data:image/jpeg;base64,' . base64_encode($graph) . '" alt="Imagem" style="width: 48%; height: 50%; margin-top: 20px">
                                <img src="data:image/jpeg;base64,' . base64_encode($graph) . '" alt="Imagem2" style="width: 48%; height: 50%; margin-top: 20px">
                            </div>
                        </div>
                    </td>
                </tr>
