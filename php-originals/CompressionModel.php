    ...
    try {
      ...
      $html = '<html>
        ...
        ' . (!empty($dataHeaderAndFooter['Localizacao']) ? $dataHeaderAndFooter['Localizacao'] : '---') . '
            ...
            <table class="tg">
                <tr>
                  <td class="tg-0pky" colspan="13" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 675px">
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="tg-compression-6rs4">cm³</td>
                          ...
                          <tr>
                            ...
                            <td class="tg-compression-78ff">' . $dataEnsaioCompactacao['SecaCapsulaP42'] . '</td>
                             <td class="tg-compression-78ff">' . $dataEnsaioCompactacao['SecaCapsulaP43'] . '</td>
                          ...
                          <tr>
                            ...
                            <td class="tg-compression-78ff">' . $dataEnsaioCompactacao['MassaAguaP53'] . '</td>
                            <td class="tg-compression-gzo9"></td>
                            <td class="tg-compression-p1nr"></td>
                            <td class="tg-compression-p1nr"></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="tg-compression-78ff">' . $dataEnsaioCompactacao['TeorUmidadeP52'] . '</td>
                          ...
                          <tr>
                            ...
                            <td class="tg-compression-7wru" style="text-align: center">w</td>
                            <td class="tg-compression-6rs4">%</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' . $dataEnsaioCompactacao['UmidadeMediaP1'] . '</td>
                            <td class="tg-compression-4nn5" colspan="3"  style=" font-size: 12px;">' . $dataEnsaioCompactacao['UmidadeMediaP2'] . '</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' . $dataEnsaioCompactacao['UmidadeMediaP3'] . '</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' .$dataEnsaioCompactacao['UmidadeMediaP4'] . '</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' .$dataEnsaioCompactacao['UmidadeMediaP5'] . '</td>
                            <td class="tg-compression-fmch" colspan="3"></td>
                          </tr>
                          <tr>
                            <td class="tg-compression-7wru" colspan="2">Massa especifica seca</td>
                            <td class="tg-compression-7wru" style="text-align: center"><p style="font-family: DejaVu Sans !important">ρ<w style="font-size: 0.7em; vertical-align: sub;">d</w></p></td>
                            <td class="tg-compression-6rs4">g/cm³</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' . number_format     ($dataEnsaioCompactacao['MassaEspSecaP1'], 3 ) . '</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' . number_format($dataEnsaioCompactacao['MassaEspSecaP2'], 3) . '</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' . number_format($dataEnsaioCompactacao['MassaEspSecaP3'], 3 ) . '</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' . number_format($dataEnsaioCompactacao['MassaEspSecaP4'], 3 ) . '</td>
                            <td class="tg-compression-4nn5" colspan="3" style=" font-size: 12px;">' . number_format($dataEnsaioCompactacao['MassaEspSecaP5'], 3 ) . '</td>
                            <td class="tg-compression-fmch" colspan="3" style=" font-size: 12px;"></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
