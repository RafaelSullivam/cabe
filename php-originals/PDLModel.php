...
class PDLModel
{
    ...
    public function generateModel($codSample, $numberSample, $datapdl, $logo, $dataCadastroAmostra,$pagina, $totalPaginas)
    {
        ...
        if (strtolower($status) === 'aprovado') {
            $aprovadoStyle .= ' background-color: #f44336; color: #fff;'; // verde
 ...
 <header>
      ...
      <table class="tg-cabecalho" style="width: 100%;margin-bottom: 20px">
        ...
        <table class="equipments-table" style="margin-top: 0; width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 10px;">
            ...
            <tr>
                <td style="border: 1px solid #000; padding: 5px; height: 20px;">' . $datapdl['Equipamento_pdl'] . '</td>
                <td style="border: 1px solid #000; padding: 5px; height: 20px;"></td>
                <td style="border: 1px solid #000; padding: 5px; height: 20px;"></td>
                <td rowspan="3" style="border: 1px solid #000; padding: 5px; text-align: center;  font-size: 12px;">' . $datapdl['TipoSolo_1'] . '</td>
<td rowspan="3" style="border: 1px solid #000; padding: 5px; text-align: center;  font-size: 12px;">' . $datapdl['MarcacaoLeitura_1'] . '</td>
            </tr>
        ...
        <table class="furo-table" style="margin: 20px 0 20px 0; width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 11px; table-layout: fixed;">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="width: 20%; border: 1px solid #000; padding: 5px; background-color: #f0f0f0; font-weight: bold; white-space: nowrap;">qd (MegaPascal)</th>
                </tr>
            </thead>
            <tbody>
         ...
         ' . $furoRows . '
            ...
            <footer style=" bottom: 0; width: 100%; font-family: Arial, sans-serif; font-size: 10px;">
