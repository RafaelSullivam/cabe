...
class CaliforniaSupportIndexModel
{
    ...
    $assinaturaVerificador = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <table class="tg-cabecalho" style="width: 100%;margin-bottom: 13px">
                ...
                <table class="tg">
                        <tr>
        <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important;margin-top: -15px; height: 675px;">               
        <p
                      style="
                    ...
                    <div class="checkbox">
                      <input
                        ...
                        id="checkbox1"
                        name="checkboxes"
                        value="checkbox1" ' . ($dataIndiceSuporteCalifornia['Energia_de_Compactacao'] === "Normal" ? 'checked="checked"' : '') . '
                      />
                      <label
                        for="checkbox1"
                    ...
                    <div class="checkbox" style="margin-left: 18px">
                      <input
                        ...
                        id="checkbox2"
                        name="checkboxes"
                        value="checkbox2" ' . ($dataIndiceSuporteCalifornia['Energia_de_Compactacao'] === "Intenormal" ? 'checked="checked"' : '') . '
                      />
                      <label
                        for="checkbox2"
                        style="font-size: 10px; vertical-align: middle"
                    ...
                    <div class="checkbox" style="margin-left: 18px">
                      <input
                        ...
                        id="checkbox3"
                        name="checkboxes"
                        value="checkbox3" ' . ($dataIndiceSuporteCalifornia['Energia_de_Compactacao'] === "Intermediaria" ? 'checked="checked"' : '') . '
                      />
                      <label
                        for="checkbox3"
                        style="font-size: 10px; vertical-align: middle"
                    ...
                    <div class="checkbox" style="margin-left: 18px">
                      <input
                        ...
                        id="checkbox3"
                        name="checkboxes"
                        value="checkbox3" ' . ($dataIndiceSuporteCalifornia['Energia_de_Compactacao'] === "Intermodificada" ? 'checked="checked"' : '') . '
                      />
                      <label
                        for="checkbox4"
                        style="font-size: 10px; vertical-align: middle"
                    ...
                    <div class="checkbox" style="margin-left: 19px">
                      <input
                        ...
                        id="checkbox4"
                        name="checkboxes"
                        value="checkbox3" ' . ($dataIndiceSuporteCalifornia['Energia_de_Compactacao'] === "Modificada" ? 'checked="checked"' : '') . '
                      />
                      <label
                        for="checkbox4"
                        style="font-size: 10px; vertical-align: middle"
                    ...
                    <div class="checkbox" style="margin-left: 19px">
                      <input
                        ...
                        id="checkbox4"
                        name="checkboxes"
                        value="checkbox3" ' . ($dataIndiceSuporteCalifornia['Energia_de_Compactacao'] === "Outro" ? 'checked="checked"' : '') . '
                      />
                      <label
                        for="checkbox4"
                        style="font-size: 10px; vertical-align: middle"
                      ...
                      >
                                ...
                                <table class="tg-moldagem" style="width: 100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tg-moldagem-78ff" colspan="3" style="min-width: 75px">' . $dataIndiceSuporteCalifornia['VolumeMolde6'] . '</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-moldagem-kd1j">Massa específica úmida</td>
                                            <td class="tg-moldagem-78ff">g/cm³</td>
                                            <td class="tg-moldagem-78ff" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['Massa_EspUmd1']) . '</td>
                                            <td class="tg-moldagem-78ff" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['Massa_EspUmd2']) . '</td>
                                            <td class="tg-moldagem-78ff" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['Massa_EspUmd3']) . '</td>
                                            <td class="tg-moldagem-78ff" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['Massa_EspUmd4']) . '</td>
                                            <td class="tg-moldagem-78ff" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['Massa_EspUmd5']) . '</td>
                                            <td class="tg-moldagem-78ff" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['Massa_EspUmd6']) . '</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tg-moldagem-78ff">%</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . $dataIndiceSuporteCalifornia['UmidadeMedia1'] . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . $dataIndiceSuporteCalifornia['UmidadeMedia2'] . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . $dataIndiceSuporteCalifornia['UmidadeMedia3'] . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . $dataIndiceSuporteCalifornia['UmidadeMedia4'] . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . $dataIndiceSuporteCalifornia['UmidadeMedia5'] . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . $dataIndiceSuporteCalifornia['UmidadeMedia6'] . '</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-moldagem-kd1j">Massa específica seca</td>
                                            <td class="tg-moldagem-78ff">g/cm³</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['MassaEspSeca1']) . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['MassaEspSeca2']) . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['MassaEspSeca3']) . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['MassaEspSeca4']) . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['MassaEspSeca5']) . '</td>
                                            <td class="tg-moldagem-k23d" colspan="3">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['MassaEspSeca6']) . '</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br />
                                ...
                                <table class="tg-expansao" style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="tg-expansao-88oy" colspan="2">Altura do CP (mm)</td>
                                            <td class="tg-expansao-88oy" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['AlturaDoMolde1']) . '</td>
                                            <td class="tg-expansao-88oy" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['AlturaDoMolde2']) . '</td>
                                            <td class="tg-expansao-88oy" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['AlturaDoMolde3']) . '</td>
                                            <td class="tg-expansao-88oy" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['AlturaDoMolde4']) . '</td>
                                            <td class="tg-expansao-88oy" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['AlturaDoMolde5']) . '</td>
                                            <td class="tg-expansao-88oy" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['AlturaDoMolde6']) . '</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="tg-expansao-88oy">' . date('d/m/Y',strtotime($dataIndiceSuporteCalifornia['DataExpansao1'])) . '</td>
                                            ...
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao1'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao6'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao6'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao11'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao11'] . '</td>
                                            <td class="tg-expansao-88oy" >' . $dataIndiceSuporteCalifornia['LeituraExpansao16'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao16'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao21'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao21'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao26'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao26'] . '</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-expansao-88oy">' . date('d/m/Y',strtotime($dataIndiceSuporteCalifornia['DataExpansao2'])) . '</td>
                                            ...
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao2'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao7'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao7'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao12'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao12'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao17'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao17'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao22'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao22'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao27'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao27'] . '</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-expansao-88oy">' . date('d/m/Y',strtotime($dataIndiceSuporteCalifornia['DataExpansao3'])) . '</td>
                                            ...
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao3'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao8'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao8'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao13'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao13'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao18'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao18'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao23'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao23'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao28'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao28'] . '</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-expansao-88oy">' . date('d/m/Y',strtotime($dataIndiceSuporteCalifornia['DataExpansao4'])) . '</td>
                                            ...
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao4'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao9'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao9'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao14'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao14'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao19'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao19'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao24'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao24'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao29'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao29'] . '</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-expansao-88oy">' . date('d/m/Y',strtotime($dataIndiceSuporteCalifornia['DataExpansao5'])) . '</td>
                                            ...
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao5'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao10'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao10'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao15'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao15'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao20'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao20'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao25'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao25'] . '</td>
                                            <td class="tg-expansao-88oy">' . $dataIndiceSuporteCalifornia['LeituraExpansao30'] . '</td>
                                            <td class="tg-expansao-88oy" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Expansao30'] . '</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br />
                                ...
                                <table class="tg-penetracao" style="width: 100%">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="tg-penetracao-6rs4" colspan="2">Penetração do corpo de prova</th>
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao1'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga16'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao16'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga31'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao31'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga46'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao46'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga61'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao61'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga76'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao76'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao2'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga17'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao17'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga32'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao32'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga47'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao47'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga62'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao62'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga77'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao77'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao3'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga18'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao18'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga33'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao33'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga48'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao48'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga63'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao63'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga78'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao78'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao4'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga19'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao19'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga34'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao34'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga49'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao49'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga64'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao64'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga79'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao79'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao5'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga20'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao20'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga35'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao35'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga50'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao50'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga65'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao65'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga80'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao80'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao6'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga21'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao21'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga36'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao36'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga51'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao51'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga66'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao66'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga81'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao81'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao7'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga22'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao22'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga37'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao37'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga52'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao52'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga67'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao67'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga82'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao82'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao8'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga23'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao23'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga38'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao38'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga53'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao53'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga68'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao68'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga83'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao83'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao9'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga24'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao24'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga39'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao39'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga54'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao54'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga69'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao69'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga84'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao84'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao10'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga25'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao25'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga40'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao40'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga55'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao55'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga70'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao70'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga85'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao85'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao11'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga26'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao26'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga41'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao41'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga56'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao56'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga71'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao71'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga86'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao86'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao12'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga27'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao27'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga42'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao42'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga57'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao57'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga72'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao72'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga87'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao87'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao13'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga28'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao28'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga43'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao43'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga58'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao58'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga73'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao73'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga88'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao88'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao14'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga29'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao29'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga44'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao44'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga59'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao59'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga74'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao74'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga89'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao89'] . '</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao15'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga30'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao30'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga45'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao45'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga60'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao60'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga75'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao75'] . '</td>
                                            <td class="tg-penetracao-78ff">' . $dataIndiceSuporteCalifornia['Carga90'] . '</td>
                                            <td class="tg-penetracao-78ff" style="background-color:silver; font-weight: bold">' . $dataIndiceSuporteCalifornia['Pressao90'] . '</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br>
