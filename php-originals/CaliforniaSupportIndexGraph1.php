...
class CaliforniaSupportIndexGraph1
{
        ...
        <style type="text/css">
            ...
            .tg-gr1 .tg-gr1-ltad {
                ...
                vertical-align: middle;
                 ...
                 #imagem-sobrepostaCBR1 {
                    position: absolute;
                    top: 250; /* Ajuste a posição vertical conforme necessário */
                    left: 60; /* Ajuste a posição horizontal conforme necessário */
    ...
    <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 675px;">
                            <div style="border: 1px solid #000; margin: 10px 0px 0px 0px; padding: 2px;">
                              <img src="data:image/jpeg;base64,' . base64_encode($graph) . '" alt="Imagem" width="700px" height="490px" style="visibility: hidden;">
                       <img src="data:image/jpeg;base64,' . base64_encode($graph) . '" alt="Imagem" width="575px" height="430px" id="imagem-sobrepostaCBR1">
                            </div>

                            <table class="tg-gr1" style="width: 100%;margin-top: 10px">
                                <colgroup>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tg-gr1-6nwz" style="width: 30px">w</td>
                                        ...
                                        <td class="tg-gr1-6nwz" style="width: 85px">' . $dataIndiceSuporteCalifornia['U_MEDIA6'] . '</td>
                                    </tr>
                                    <tr>
                                        <td class="tg-gr1-ltad">Massa específica seca</td>
                                        <td class="tg-gr1-6nwz">ρ<w style="font-size: 0.7em; vertical-align: sub;">s</w></td>
                                        <td class="tg-gr1-6nwz">g/cm³</td>
                                        <td class="tg-gr1-6nwz" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['M_SECA1']) . '</td>
                                        <td class="tg-gr1-6nwz">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['M_SECA2']) . '</td>
                                        <td class="tg-gr1-6nwz">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['M_SECA3']) . '</td>
                                        <td class="tg-gr1-6nwz">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['M_SECA4']) . '</td>
                                        <td class="tg-gr1-6nwz" colspan="2">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['M_SECA5']) . '</td>
                                        <td class="tg-gr1-6nwz">' . str_replace('.', ',', $dataIndiceSuporteCalifornia['M_SECA6']) . '</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="tg-gr1-6nwz">' . $dataIndiceSuporteCalifornia['G1_CR_P61'] . '</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="tg-gr1-6nwz">' . $dataIndiceSuporteCalifornia['G1_Do_P62'] . '</td>
                                    </tr>
                                    <tr>
                                        <td class="tg-gr1-ltad" colspan="4" style="width: 300px">Teor de umidade ótimo</td>
                                        <td class="tg-gr1-6nwz">%</td>
                                        <td class="tg-gr1-6nwz" style="background-color:silver; font-weight:bold">' . $dataIndiceSuporteCalifornia['Twopt'] . '</td>
                                        <td class="tg-gr1-6nwz" colspan="3">Massa específica seca máxima</td>
                                        <td class="tg-gr1-6nwz">g/cm³</td>
                                        <td class="tg-gr1-6nwz" style="background-color:silver; font-weight:bold">' . $dataIndiceSuporteCalifornia['gdmax'] . '</td>
                                    </tr>
                                </tbody>
                            </table>
                            <br />
