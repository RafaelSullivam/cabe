...
class ActualSpecificMassInGrainsModel
{
    ...
    public function generateModel($codSample, $numberSample, $observation, $dataHeaderAndFooter, $pagina, $totalPaginas, $dataMassaEspecificaRealEmGraos, $logo, $dataFormatada)
    {
        ...
        $assinaturaVerificador = $stmt->fetchAll(PDO::FETCH_ASSOC);
         ...
         $query = "SELECT Norma_Real_Graos FROM tipo_de_ensaio WHERE AMOSTRA = :amostra ";
        $stmt = $pdo->prepare($query);
        $stmt->bindParam(':amostra', $codSample, PDO::PARAM_STR);
        $stmt->execute();
        $Norma_Real_Graos = $stmt->fetchAll(PDO::FETCH_ASSOC);
        $html = '<html>
        <head>
            <style type="text/css">
                ...
                .tg-main-table .tg-main-table-c3ow {
                    ...
                    padding: 3px 3px;
                     ...
                     .tg-main-table .tg-main-table-c1ow {
                    border-color: inherit;
                    font-size: 12px;
                    text-align: center;
                    vertical-align: middle;
                                ...
                                <thead>
                                    <tr>
                                      <td class="tg-cabecalho-0pky" style="width: 160px !important;padding-bottom: 0px; border-top-color:#fff; border-bottom-color:#fff;white-space: nowrap; border-left-color:#fff"> 
                                            NORMA:
                                          <div style="font-size: 102x; margin-left: 10px; margin-top: 6px; margin-bottom: 5px" class="cabecalho-resultado-font">' . $Norma_Real_Graos[0]['Norma_Real_Graos'] . '</div>
                                      </td>
        ...
        ' . (!empty($dataHeaderAndFooter['Localizacao']) ? $dataHeaderAndFooter['Localizacao'] : '---') . '
            ...
            <div style="margin-top: 1%; height: 40px; text-align: left">
                    <div style="display: inline-block; padding-right: 2px">
                        <p style="font-size: 13px">Tipo de Secagem:</p>
                    </div>
                    <div style="display: inline-block; font-size: 13px; margin-top: 1px; border-left: 2px solid #000; padding-left: 8px; padding-top: 1px">
                        <input
                            ...
                            name="checkboxes"
                            value="checkbox1"
                            ' . ($dataMassaEspecificaRealEmGraos['Temp_CheckBox1'] === "COM" ? 'checked="checked"' : '') . '
                        />
                        <label
                            for="checkbox1"
                        ...
                        <input
                            ...
                            name="checkboxes"
                            value="checkbox2"
                            ' . ($dataMassaEspecificaRealEmGraos['Temp_CheckBox2'] === "SEM" ? 'checked="checked"' : '') . '
                        />
                        <label
                            for="checkbox2"
                            style="font-size: 10px; vertical-align: middle"
                ...
                <table class="tg" style="margin-Top: 0px; padding-right: 0px !important; width: 760px !important;">
                        <tr>
        <td colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 635px; width: 760px !important;">
                                <br/>
                                
                                <div class="tg-main-table-wrap">
                                    <table class="tg-main-table" style="width: 760px">
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="tg-main-table-fymr" >Corpo de prova</td>
                                                <td class="tg-main-table-c3ow">N°</td>
                                                <td class="tg-main-table-c1ow"></td>
                                                <td class="tg-main-table-c3ow" colspan="3">I</td>
                                                <td class="tg-main-table-c3ow" colspan="3">II</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tg-main-table-c3ow">M<w style="font-size: 0.7em; vertical-align: sub;">1</w></td>
                                                <td class="tg-main-table-c1ow"></td>
                                                <td class="tg-main-table-c3ow" colspan="3">' . $dataMassaEspecificaRealEmGraos['massaUmidaDoCorpoDeProva1'] . '</td>
                                                <td class="tg-main-table-c3ow" colspan="3">' . $dataMassaEspecificaRealEmGraos['massaUmidaDoCorpoDeProva2'] . '</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tg-main-table-c3ow">Mu</td>
                                            ...
                                            <tr>
                                                <td class="tg-main-table-fymr">Teor de umidade</td>
                                                <td class="tg-main-table-c3ow">w</td>
                                                <td class="tg-main-table-c1ow">%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tg-main-table-c3ow">M<w style="font-size: 0.7em; vertical-align: sub;">3</w></td>
                                                <td class="tg-main-table-c1ow">g</td>
                                            ...
                                            <tr>
                                                <td class="tg-main-table-fymr">Massa do picnômetro + corpo de prova + água</td>
                                                <td class="tg-main-table-c3ow">M<w style="font-size: 0.7em; vertical-align: sub;">2</w></td>
                                                <td class="tg-main-table-c1ow">g</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tg-main-table-c1ow">°C</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tg-main-table-c3ow">
                                                ρ<w style="font-size: 0.7em; vertical-align: sub;">w(T)</w>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tg-main-table-c3ow">ρ<w style="font-size: 0.7em; vertical-align: sub;">s</w></td>
                                                <td class="tg-main-table-c1ow">g/cm³</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tg-main-table-c1ow">ρ<w style="font-size: 0.7em; vertical-align: sub;">s</w></td>
                                    ...
                                    <table class="tg-main-table" style="width: 760px;  margin-top: 5px;">
                                    <colgroup>
                           ...
                           <tr style="margin-top: 5px, height: 4px">
                                      <td class="tg-main-table-fymr" style="text-align: left">Incerteza Expandida</td>
                                      <td class="tg-main-table-c1ow">g/cm³</td>
                                      <td class="tg-main-table-c3ow colspan="6""   colspan="6">' . $dataMassaEspecificaRealEmGraos['incertezaexpandida'] . '</td>
                                  </tr>
                                  <tr style="margin-top: 5px, height: 5px">
                                      <td class="tg-main-table-fymr" style="text-align: left">Fator de Expansão</td>
                                      <td class="tg-main-table-c1ow">k</td>
                                      <td class="tg-main-table-c3ow colspan="6""  colspan="6">' . $dataMassaEspecificaRealEmGraos['k'] . '</td>
                                  </tr>
                          </table>
                                </div>
        ...
        <tr>            
          <td class="tg-0pky" colspan="15"  >
              ...
              <div style="height: 15px;"> ' . $dataMassaEspecificaRealEmGraos['Observacao'] . ' <div>
          </td>
          </tr>
          <tr>
               <td class="tg-0pky" colspan="5">
                  <p class="title" style="top: 0 !important">Execução: </p> 
                  <p class="title"> '  . $dataMassaEspecificaRealEmGraos['Executado']. '</p>
              </td>
              <td class="tg-0pky" colspan="5">
          ...
          <tr>
                      <td class="tg-0pky" colspan="15" style="padding: 4px 0px 0px 5px;">
                          <div style="width: 245px; display: inline-block">
                              <p class="title"> Código laboratório: PP-LB-010-02 </p>
                          </div>
