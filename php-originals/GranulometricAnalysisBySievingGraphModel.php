...
class GranulometricAnalysisBySievingGraphModel
{
  private $data;
  ...
  public function generateModel($codSample, $numberSample, $observation, $dataHeaderAndFooter, $pagina, $totalPaginas, $logo, $dataFormatada, $dataAnaliseGranulometricaPeineiramento)
  {
    ...
    $query = "SELECT * FROM ImagemGranulometrico WHERE Amostra = :codSample AND N_Ensaio = :numberSample";
    ...
    $query = "SELECT * FROM Login WHERE usuario = :aprovador";
    $stmt = $pdo->prepare($query);
    ...
    $html = '<html>
        ...
        <table class="tg-cabecalho" style="width: 100%;margin-bottom: 13px">
            ...
            <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 675px;">
              <div style="border: 1px solid #000; margin: 15px 0px 0px 0px; padding: 5px 5px -1px 5px">
              <div style="width: 50%; margin-left: 30%; position: absolute; z-index: 1; top: 290px; height: 40px; font-size: 15px; background-color: #fff;">CURVA DE DISTRIBUIÇÃO GRANULOMÉTRICA</div>
              <div style="width: 84%; margin-left: 36%; position: absolute; z-index: 1; top: 323px">
              <div style="display: inline-block; font-size: 9px; margin-right: 15px">
                200
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 12px">
                100
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 10px">
                60
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 6px">
                40
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 20px">
                30
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 12px">
                16
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 34px">
                10
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 21px">
                4
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 15px">
                3/8"
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 1px">
                3/4"
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 2px">
                1"
              </div>
              <div style="display: inline-block; font-size: 8px; margin-right: 2px; font-family: DejaVu Sans !important">
                1-&#189;"
              </div>
              <div style="display: inline-block; font-size: 9px; margin-right: 17px;">
                2"
              </div>
          </div>
          <div style="width: 84%; margin-left: 36%; position: absolute; z-index: 1; top: 775px">
                        <div style="display: inline-block; font-size: 9px; margin-right: 4px">
                          0,075
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 4px">
                          0,150
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 5px">
                          0,250
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 2px">
                          0,425
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 8px">
                          0,600
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 8px">
                          1,12
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 22px">
                          2,00
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 16px">
                          4,75
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 8px">
                          9,51
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 0px">
                          19,1
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 1px">
                          25,4
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 0px; font-family: DejaVu Sans !important">
                          38,1
                        </div>
                        <div style="display: inline-block; font-size: 9px; margin-right: 17px;">
                          50,8
          ...
          <tr>
              <td class="tg-0pky" colspan="5">
                  ...
                  <p class="title"> '  . $dataAnaliseGranulometricaPeineiramento['Executado']. '</p>
              </td>
              <td class="tg-0pky" colspan="5">
