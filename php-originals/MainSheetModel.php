<?php
   ...
   class MainSheetModel
   {
      ...
      public function generateModel(
         ...
         $dataCabecalho = count($response) === 0 ? null : $response[0];

         
         $aprovador = $dataFolhaRosto['Aprovacao'];
         $verificador =  $dataFolhaRosto['Verificacao'];
          ...
          .tg-cabecalho .tg-cabecalho-0pky .title {
            ...
            .col-1 {
             ...
             .tg-adensamento  {border-collapse:none}
               .tg-adensamento td{border: none;font-family:Arial Unicode MS, DejaVu Sans, Arial, sans-serif;font-size:10px;
               overflow:hidden;padding:0px 0px;word-break:normal;}
               .tg-adensamento th{border: none;font-family:Arial Unicode MS, DejaVu Sans, Arial, sans-serif;font-size:10px;
    ...
    <body>
       ...
       <table class="tg-cabecalho" style="width: 100%;margin-bottom: 13px">
         ...
         <tr>
            <th class="tg-cabecalho-0pky" colspan="1" class="col-2">PROCESSO / LOTE:<br> <div style="text-align: center; font-size: 13px; margin-top: 4px" class="cabecalho-resultado-font">' . $dataHeaderAndFooter['Processo'] . ' / ' . $dataHeaderAndFooter['Lote'] . '</div></th>
         ...
         <tr>
            ...
            <td class="tg-cabecalho-0pky col-2" colspan="1" rowspan="4">DATA DE VERIFICAÇÃO:<div style="margin-top: 15px"><span class="cabecalho-resultado-font">' . $dataFolhaRosto['Data_Verificado'] . '</span></div></td>
         ...
         <tr>
            <td class="tg-cabecalho-0pky" rowspan="2">DATA DE CONCLUSÃO:<div style="margin-top: 15px"><span class="cabecalho-resultado-font">' .$dataFolhaRosto['Data_Aprovado'] . '</span></div><br></td>
         ...
         <tr>
            <td class="tg-cabecalho-0pky">**LOCAL DA COLETA / ENDEREÇO: <br> <div style="text-align: center; font-size: 12px">
          ...
          <tbody>
             <tr>
                <td class="tg-0pky" colspan="15">
                   <div
                      ...
                      >
                      Responsabilidade da amostragem: <span class="cabecalho-resultado-font">' . $dataFolhaRosto['Responsabilidade_Amostragem'] . '</span>
                   </div>
             ...
             <tr>
                <td class="tg-0pky" colspan="15" style="padding: 0px 0px 0px 4px !important;">
                   ...
                   <p
                      ...
                      >
                      Classificação: (ASTM D2487-00) <span class="cabecalho-resultado-font">' . $dataFolhaRosto['Class_1'] . '</span>
                   </p>
                   <p class="response" style="display: inline-block; margin-right: 5%;">
                      (ASTM D3282-09) <span class="cabecalho-resultado-font">' . $dataFolhaRosto['Class_2'] . '</span>
                   </p>
                   <br>
                   <p class="response" style="display: inline-block; margin-top: 12px !important">
                      Descrição do solo: <span class="cabecalho-resultado-font">' . $dataFolhaRosto['DescricaoDoSolo'] . '</span>
                   </p>
                </td>
             </tr>
             <!--========================Ensaio=========================-->
             ...
             <tr>
               <td class="tg-0pky" colspan="15" style="padding: 0px 0px 0px 4px !important;">
                   ...
                   <p
                      ...
                      >
                      LL (%): <span class="cabecalho-resultado-font">' . ($dataLimitesAttemberg === null ? '' : ($np ? "NL" : $dataLimitesAttemberg['LL'])) . '</span>
                   </p>
                   <p
                      class="response"
                      style="display: inline-block; margin-right: 16%"
                   ...
                   <p
                      ...
                      >
                      IP (%): <span class="cabecalho-resultado-font">' . ($dataLimitesAttemberg === null ? '' : ($np ? "---" :  $dataLimitesAttemberg['IP'])) . '</span>
                   </p>
                   <p
                      class="response"
                      style="display: inline-block; margin-right: 16%"
                   ...
                   <p
                      ...
                      >
                      IC (%): <span class="cabecalho-resultado-font">' . ($dataLimitesAttemberg === null ? '' : ($np ? "---" : $dataLimitesAttemberg['IC'])) . '</span>
                   </p>
                </td>
             </tr>
             ...
             <tr>
               <td class="tg-0pky" colspan="15" style="padding: 0px 0px 0px 4px !important;">
                   ...
                   <p class="response" style="display: inline-block; margin-right: 5%">
                      &#37;&lt;4.75mm: <span class="cabecalho-resultado-font">' . ($dataANALISE_GRANULOMETRICA_SEDIMENTACAO === null ? '' : $dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino1'] = number_format($dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino1'], 1, ',', '')) . '</span>
                   </p>
                   <p class="response" style="display: inline-block; margin-right: 5%">
                      &#37;&lt;2.00mm: <span class="cabecalho-resultado-font">' . ($dataANALISE_GRANULOMETRICA_SEDIMENTACAO === null ? '' : $dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino2'] = number_format($dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino2'], 1, ',', '')) . '</span>
                   </p>
                   <p class="response" style="display: inline-block; margin-right: 5%">
                      &#37;&lt;0.42mm: <span class="cabecalho-resultado-font">' . ($dataANALISE_GRANULOMETRICA_SEDIMENTACAO === null ? '' : $dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino5'] = number_format($dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino5'], 1, ',', '')) . '</span>
                   </p>
                   <p class="response" style="display: inline-block; margin-right: 6%">
                      &#37;&lt;0.75mm: <span class="cabecalho-resultado-font">' . ($dataANALISE_GRANULOMETRICA_SEDIMENTACAO === null ? '' : $dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino8'] = number_format($dataANALISE_GRANULOMETRICA_SEDIMENTACAO['PassadosFino8'], 1, ',', '')) . '</span>
                   </p>
                   <p class="response" style="display: inline-block; margin-right: 5%">
                ...
                <td class="tg-0pky" colspan="15">
                   <div style="margin-top: 1px">
                      ...
                      <div class="checkbox">
                         ...
                         <label for="checkbox3" style="font-size: 10px; vertical-align: middle;">Intermediário</label>
                      </div>
                      <div class="checkbox">
                         ...
                         <label for="checkbox4" style="font-size: 10px; vertical-align: middle;">Intermodificado</label>
                      </div>
                      ...
                      <div class="checkbox">
                         ...
                         <label for="checkbox4" style="font-size: 10px; vertical-align: middle;">Modificado</label>
                      </div>
                      
                     
                      <div style="display: inline-block; margin-left: 50px; height: 20px">
    <p class="response" style="margin-bottom: 6px !important">Massa Esp. seca max(ys): <span class="cabecalho-resultado-font">' . ($dataEnsaioCompactacao === null ? '' : $dataEnsaioCompactacao['Ydmax']) . ' g/cm³</span></p>
    <p class="response" style="margin-left: 11px;margin-bottom: 15px;">Teor ótimo de umidade: <span class="cabecalho-resultado-font">' . ($dataEnsaioCompactacao === null ? '' : $dataEnsaioCompactacao['Twopt']) . ' %</span></p>
</div>
             ...
             <tr>
               <td class="tg-0pky" colspan="11" style="padding: 0px 0px 0px 4px !important;">
                   ...
                   <div style="height: 88px">
                     ...
                     <div style="display: inline-block; width: 29%; margin-bottom: 12px; margin-left:7px;">
                        <table class="tg" style="width: 382px;">
                           <tbody>
                              <tr>
                                 <td class="tg-0pky" style="padding-right: -15px !important;font-size: 10px; padding: 0;text-align: right;border-top-color: #fff; border-left-color: #fff; border-bottom-color: #fff">Teor de umidade:</td>
                              ...
                              <tr>
                                 ...
                                 <td class="tg-0pky" style="padding: 3px; font-weight: bold; font-size: 10px; border-right-color: #fff; text-align: center;">g/cm³</td>
                              </tr>
                              <tr>
             ...
             <tr>
                <td class="tg-0pky" colspan="11" style="padding: 0px 0px 0px 4px !important;">
                   ...
                   <div style="display: inline-block; width: 30%;">
                      <table class="tg" style="width: 455px; margin-left: 18px">
                         <tbody>
                            <tr>
                ...
                <td class="tg-0pky" colspan="4">
                  ...
                  <tbody>
                     <tr>
                      ...
                      <td class="tg-adensamento-0lax">Cv: <span style="margin-left: 50%">cm³/s</span></td>
                    </tr>
                    <tr>
                     <td class="tg-adensamento-0lax">σp: <span style="margin-left: 47%">KPa<span></td>
                      <td class="tg-adensamento-0lax">K: <span style="margin-left: 56%">cm/s</span></td>
                    </tr>
                    <tr>
                      <td class="tg-adensamento-0lax">e0: </td>
                ...
                <td class="tg-0pky" colspan="4">
                   <div style="text-align: center;">
                     <p style="font-size: 13px; margin-top: -21px !important; margin-bottom: 0px !important;font-weight: bold">Ensaio de resistência</p>
                      ...
                      <p class="response"style="margin-left: -10px;">Resistência qu: <span class="cabecalho-resultado-font"></span></p>
                      <p class="response "style="margin-left: -10px;">Módulo de deformabilidade Ei: <span class="cabecalho-resultado-font"style="margin-left: -10px;"></span></p>
                      <p class="response"style="margin-left: -10px;">Deformação na rotura: <span class="cabecalho-resultado-font"></span></p>
                   </div>
                </td>
             </tr>
             ...
             <tr>
               <td class="tg-0pky" colspan="15">
                  ...
                  <div style="height: 15px;">' . $dataFolhaRosto['Observacao'] . ' <div>
               </td>
            </tr>
             <tr>
               <td class="tg-0pky" colspan="5">
                  ...
                  <td class="tg-0pky" colspan="5">
                     <p class="title" style="top: 0 !important">Verificação: </p> ' . (!empty($assinaturaVerificador) ? ' <img style="margin: 1px 0px 0px 50px" src="data:image/jpeg;base64,' . base64_encode($assinaturaVerificador[0]['Assinatura']) . '" alt="Imagem" height="10px" width="70px">
                  ...
                  <td class="tg-0pky" colspan="5" style="overflow: hidden;">
                    ...
                    ' . (!empty($assinaturaAprovador) ? '
                        ...
                        <tr style="border: none;">
                            ...
                            <img src="data:image/jpeg;base64,' . base64_encode($assinaturaAprovador[0]['Assinatura']) . '" alt="Imagem" height="10px" width="70px"><br>
                            <p class="title" style="margin: 0;">' . $assinaturaAprovador[0]['Nome'] . '</p>
                            </td>
                            <td style="text-align: center; border: none;">
                            <img src="data:image/jpeg;base64,' . base64_encode($assinaturaMarciel[0]['Assinatura']) . '" alt="Imagem" height="10px" width="70px"><br>
            ...
            <td class="tg-0pky" colspan="15" style="padding: 4px 0px 0px 5px;">
                <div style="width: 245px; display: inline-block">
                    <p class="title"> Código laboratório: PP-LB-000-06 </p>
                </div>
       ...
       <footer>
       <div style="text-align: center">
       <p style="font-size: 10px; font-weight: bold; margin: -2; font-family: Arial, sans-serif; !important">Este relatório de ensaio só pode ser copiado integralmente ou parcialmente com autorização da Geocontrole</p>
