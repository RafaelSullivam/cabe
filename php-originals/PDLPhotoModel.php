          ...
          <!--Acima Cabeçalho -->
            ...
            <table style="margin-top: 50px;">
                <tr>
                  <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 10px;">
                    <div style="border: 1px solid #000; margin: 30px 0px 0px 0px; padding: 5px 5px 0px 5px">
                      <div style="width: 50%; margin-left: 40%;font-family: Arial, sans-serif; position: absolute; z-index: 1; top: 335px; height: 30px; font-size: 15px; background-color: #fff;">REGISTRO FOTOGRÁFICO</div>
                        <img src="data:image/jpeg;base64,' . $photo . '" alt="Imagem" width="500px" height="240px" style="visibility: hidden;">
                       <img src="data:image/jpeg;base64,' . $photo . '" alt="Imagem" width="475px" height="200px" style="margin-top: 20px;margin-left: 10%;" id="imagem-sobrepostaComp">
                ...
                <tr>
                  <td class="tg-0pky" colspan="15" style="border-left: none !important; border-right: none !important; border-top-color: #fff; padding-left: 0px !important; padding-right: 0px !important; height: 10px;">
                    <div style="border: 1px solid #000; margin: 30px 0px 0px 0px; padding: 5px 5px 0px 5px">
                      <div style="width: 50%; margin-left: 40%;font-family: Arial, sans-serif; position: absolute; z-index: 1; top: 617px; height: 30px; font-size: 15px; background-color: #fff;">GEOLOCALIZAÇÃO</div>
                        <img src="data:image/jpeg;base64,' . $mapa . '" alt="Imagem" width="500px" height="240px" style="visibility: hidden;">
                       <img src="data:image/jpeg;base64,' . $mapa . '" alt="Imagem" width="475px" height="200px" style="margin-top: 300px;margin-left: 10%;" id="imagem-sobrepostaComp">
                    ...
                    <footer style=" bottom: 0;margin-top: 50; width: 100%; font-family: Arial, sans-serif; font-size: 10px;">
